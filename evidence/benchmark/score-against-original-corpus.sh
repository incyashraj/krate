...
# as it stood for run 2 (commit eea8dd3), before any edit of mine.
set -uo pipefail
...
git show eea8dd3:evidence/benchmark/corpus.tsv > /tmp/corpus_orig.tsv 2>/dev/null
pass=0; tot=0
...
echo "against run 2 corpus (pre-my-edits): $pass of $tot recorded requests pass"
