...
| 3 | UI + Graphics | Started | 2026-05-19 | pending | Phase 3 has begun at the contract layer: draft GUI WIT, GUI manifest recognition, first `ui`/`gfx`/`audio` capability names, shared in-memory UI adapter model, and runtime UI dispatcher scaffold are in place. |
