...
| SDKs | Rust is usable; Go scaffold is ready; TypeScript scaffold plus auto-build lane and passing local clock/cat fixtures are ready | Publish-ready Rust after freeze, TinyGo runtime proof, always-on jco runtime proof on hosted CI, and stable TS curl fixture evidence on restricted runners. |
