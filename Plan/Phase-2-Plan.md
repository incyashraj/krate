...
| 4 | Go (TinyGo) bindings generated and usable; sample builds and runs | Advanced: `layer36 doctor` now reports TinyGo and Go readiness, `packages/sdk-go` has the helper scaffold and examples, and self-hosted CI now runs a TinyGo WASI Preview 2 build-smoke lane for clock/cat/curl with component-shape verification; generated binding module and Layer36-runtime fixture proof remain |
...
| Formal Phase 2 exit | About 55-60% complete | Language runtime proofs, seven-day CI evidence, fuzzing, full benchmark gate, and external validation. |
