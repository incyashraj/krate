// Adapted from David Peter's hexyl; see NOTICE and LICENSE-MIT.
// Host I/O/clap are replaced for a no_std Krate guest; read errors propagate.
use crate::colors::*;
use alloc::{
    format,
...
use crate::guest_io::{self as io, BufReader, Read, Write};
