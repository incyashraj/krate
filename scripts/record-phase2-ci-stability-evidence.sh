...
REQUIRE_SUCCESS="${KRATE_CI_STABILITY_REQUIRE_SUCCESS:-0}"
MIN_SUCCESS_STREAK="${KRATE_CI_STABILITY_MIN_SUCCESS_STREAK:-1}"
...
Environment:
  KRATE_CI_STABILITY_REPO
  KRATE_CI_STABILITY_BRANCH
  KRATE_CI_STABILITY_LIMIT
  KRATE_CI_STABILITY_CREATED
  KRATE_CI_STABILITY_REQUIRE_SUCCESS
  KRATE_CI_STABILITY_MIN_SUCCESS_STREAK
USAGE
}
