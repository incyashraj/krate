...
REQUIRE_SUCCESS="${KRATE_SELF_HOSTED_REQUIRE_SUCCESS:-0}"
MIN_SUCCESS_STREAK="${KRATE_SELF_HOSTED_MIN_SUCCESS_STREAK:-1}"
CREATED_FILTER="${KRATE_SELF_HOSTED_CREATED:-}"
...
Environment:
  KRATE_SELF_HOSTED_REPO
  KRATE_SELF_HOSTED_BRANCH
  KRATE_SELF_HOSTED_WORKFLOW
  KRATE_SELF_HOSTED_LIMIT
  KRATE_SELF_HOSTED_CREATED
  KRATE_SELF_HOSTED_REQUIRE_SUCCESS
  KRATE_SELF_HOSTED_MIN_SUCCESS_STREAK
USAGE
}
