...
Krate is an experiment in making native application development portable again.
...
Krate is still pre-alpha, but the repo is now past the original foundation
